...
public class ParagrapheIdValidationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        boolean canFilter = actionName.equals("GET/show_paragraphe") || actionName.equals("GET/remove_paragraphe");
